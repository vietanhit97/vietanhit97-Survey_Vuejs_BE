            ...
            <div class="content mt-5">
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="text" name="" v-model="CreateSurveyDto.nameQuestionCreateSurvey" id=""
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-lg"
                                    v-model="CreateSurveyDto.questionTypeIdCreateSurvey">
                ...
                <div class="form-check" v-for="(option, index) in options" :key="index">
                    ...
                    <label class="form-check-label" :for="'option' + index">
                        <div class="col">
                            <div class="mb-3">
                                <input type="text" name="" id="" class="form-control" :placeholder="options[index]"
